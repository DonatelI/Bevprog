...
15. string s = "Success!\n"; for (int i=0; i<6; ++i) cout << s[i];      ->      string s = "Success!"; for (int i=0; i<8; ++i) cout << s[i]; cout << "\n";

16. if (true) then cout << "Success!\n"; else cout << "Fail!\n";        ->      if (true) cout << "Success!\n"; else cout << "Fail!\n";

17. int x = 2000; char c = x; if (c==2000) cout << "Success!\n";        ->      int x = 2000; int c = x; if (c==2000) cout << "Success!\n";

18. string s = "Success!\n"; for (int i=0; i<10; ++i) cout << s[i];     ->      string s = "Success!"; for (int i=0; i<8; ++i) cout << s[i]; cout << "\n";
...
23. int i=0; while (i<10) ++j; if (j<i) cout << "Success!\n";       ->      int i=0; while (j<10) ++j; if (j>i) cout << "Success!\n";
